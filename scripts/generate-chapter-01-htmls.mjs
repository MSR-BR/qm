...
<head>
  ...
  <style>
    :root{
      ...
      --blue:#C66A1A; --blue-soft:#FFF7ED; --red:#B03A2E; --green:#1A7A4A;
      --purple:#6D28D9; --orange:#9A4E10; --orange-soft:#FFF7ED; --border:#F2C7A0; --card:#FFFFFF;
    ...
    *{box-sizing:border-box}
    ...
    .hdr{display:flex!important;align-items:flex-start!important;justify-content:space-between!important;gap:14px!important;padding:clamp(10px,1.5vw,15px) clamp(16px,2.4vw,30px)!important;margin:clamp(10px,1.5vw,14px) clamp(16px,3vw,40px) clamp(6px,1vw,10px)!important;background:#FFF7ED!important;border-left:5px solid var(--blue)!important;border-radius:6px!important;flex-shrink:0!important;}
    ...
    .key-eq{background:var(--orange-soft)!important;border:2px solid rgba(198,106,26,.42)!important;box-shadow:inset 0 0 0 1px rgba(255,255,255,.65)!important;}
    ...
    .book-figure{margin:2px 0 12px!important;padding:0!important;border:1px solid #F2C7A0!important;border-radius:8px!important;overflow:hidden!important;background:#FFFFFF!important;}
    ...
    .resource-links,.source-note{grid-column:1 / -1!important;background:#F8FAFC!important;border:1px solid #F2C7A0!important;border-radius:9px!important;padding:10px 14px!important;font-family:"Inter",sans-serif!important;font-size:.78rem!important;line-height:1.45!important;color:#526173!important;}
    ...
    .resource-link-list a{display:inline-flex!important;align-items:center!important;text-decoration:none!important;color:var(--blue)!important;background:#FFF7ED!important;border:1px solid #F2C7A0!important;border-radius:999px!important;padding:5px 10px!important;font-weight:700!important;}
