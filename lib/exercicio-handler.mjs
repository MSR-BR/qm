...
function normalizeMathText(value = "") {
  const normalized = wrapBareMathTokens(
    replaceOutsideMathSegments(repairGeneratedMathDelimiters(sanitizeGeneratedExerciseText(value))
    .replace(/\r\n?/g, "\n")
    .replace(/\\\\/g, "\\")
  ...
  return expandQuantumMacros(flattenMathDelimitersInsideSegments(cleanupNestedMathDelimiters(normalized)))
    .replace(/\\\\(?=[()[\]]|[A-Za-z])/g, "\\")
